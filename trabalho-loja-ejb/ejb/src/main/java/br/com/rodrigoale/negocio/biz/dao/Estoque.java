...
public class Estoque implements IEstoque  {
	...
	public Estoque(){
		...
		Produto p1 = new Produto("O Temor do Sabio",50);
		Produto p2  = new Produto("Senhor dos Aneis",108);
		Produto p3 = new Produto("Hobbit",38);
		Produto p4 = new Produto("O Nome do Vento",42);
		Produto p5  = new Produto("The Legend of Zelda: Breath of the Wild - Creating a Champion",133);
		Produto p6 = new Produto("Box As Cronicas de Gelo e Fogo",180);
		Produto p7 = new Produto("The Legend of Zelda: Hyrule Historia",113);
		Produto p8  = new Produto("Fogo E Sangue - Volume 1 ",56);
		Produto p9 = new Produto("Trilogia dos Espinhos",81);
